...
class MediaUploadController extends Controller
{
    ...
    public function upload_media_file(Request $request)
    {
         ...
         * @post('/admin-home/media-upload')
         * @name('admin.upload.media.file')
    ...
    public function all_upload_media_file(Request $request)
    {
         ...
         * @post('/admin-home/media-upload/all')
         * @name('admin.upload.media.file.all')
         * @middlewares(web, auth:admin)
         */
    ...
    public function delete_upload_media_file(Request $request)
    {
         ...
         * @post('/admin-home/media-upload/delete')
         * @name('admin.upload.media.file.delete')
         * @middlewares(web, auth:admin)
         */
