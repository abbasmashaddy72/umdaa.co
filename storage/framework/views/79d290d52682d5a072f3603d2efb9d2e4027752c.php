...
<head>
  <meta charset="UTF-8">
  <title>404 - UMDAA HEalth Care</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <button class="btn green"><a href="<?php echo e(url('/')); ?>">HOME</a></button>
      </div>
    </div>
  </div>
</main>
...
<?php /**PATH /srv/http/umdaa/umdaa.co/resources/views/errors/404.blade.php ENDPATH**/ ?>