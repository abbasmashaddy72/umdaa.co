...
<div class="nx-popup-wrapper <?php echo e($popup_class); ?>">
    <div class="nx-modal-content-wrapper">
        ...
        <?php elseif($popup_details->type == 'only_image'): ?>
            <div class="nx-modal-inner-content-wrapper" <?php echo render_background_image_markup_by_attachment_id($popup_details->only_image); ?>>
                <div class="nx-popup-close">×</div>
                <div class="nx-modal-content"></div>
            </div>
        <?php else: ?>
            <div class="nx-modal-inner-content-wrapper" <?php echo render_background_image_markup_by_attachment_id($popup_details->background_image); ?>>
                <div class="nx-popup-close">×</div>
                <div class="nx-modal-content">
                            ...
                            <div class="right-content-inner-wrap">
                                ...
                                <?php if(!empty($popup_details->btn_status)): ?>
                                    <div class="btn-wrapper">
                                        <a href="<?php echo e($popup_details->button_link); ?>"
                                            class="btn-boxed"><?php echo e($popup_details->button_text); ?></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php /**PATH /srv/http/umdaa/umdaa.co/resources/views/frontend/partials/popup.blade.php ENDPATH**/ ?>