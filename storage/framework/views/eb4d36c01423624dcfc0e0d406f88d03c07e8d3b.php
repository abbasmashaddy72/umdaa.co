<script>
    ...
    (function($) {
        ...
        $(document).on('click', '.media_library_image_delete_btn', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('.media-uploader-image-info a,.media-uploader-image-info .img-meta')
                    .hide();
        ...
        function selectOldImage() {
            ...
            $('.media-uploader-image-list li[data-imgid="' + imageId + '"]').addClass('selected').siblings()
...
<?php /**PATH /srv/http/umdaa/umdaa.co/resources/views/backend/partials/media-upload/media-js.blade.php ENDPATH**/ ?>