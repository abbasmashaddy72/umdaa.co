    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e('Media Uploads'); ?></h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary media_upload_modal_submit_btn"
                    style="display: none"><?php echo e('Set Image'); ?></button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /srv/http/umdaa/umdaa.co/resources/views/backend/partials/media-upload/media-upload-markup.blade.php ENDPATH**/ ?>