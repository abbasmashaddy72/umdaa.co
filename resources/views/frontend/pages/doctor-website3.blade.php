...
<head>
    ...
    @foreach ($singleDetails as $data)
        ...
        <meta property="og:url"
            content="{{ route('frontend.doctor.website3', ['id' => $data->doctor_id, 'any' => Str::slug(str_replace(' ', '', 'Dr.' . $data->first_name . $data->last_name))]) }}" />
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/aos/aos.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/bootstrap/css/bootstrap.min.css') }}"
        as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/bootstrap-icons/bootstrap-icons.css') }}"
        as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/boxicons/css/boxicons.min.css') }}"
        as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/glightbox/css/glightbox.min.css') }}"
        as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/vendor/swiper/swiper-bundle.min.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('assets/frontend/website3/css/style.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    ...
    <noscript>
        ...
        <link
            ...
            rel="stylesheet">
        <!-- Vendor CSS Files -->
        <link href="{{ asset('assets/frontend/website3/vendor/aos/aos.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/website3/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/website3/vendor/bootstrap-icons/bootstrap-icons.css') }}"
            rel="stylesheet">
        <link href="{{ asset('assets/frontend/website3/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/website3/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/website3/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
        <!-- Template Main CSS File -->
        <link href="{{ asset('assets/frontend/website3/css/style.css') }}" rel="stylesheet">
    </noscript>
    <style>
        .banner-img img {
            width: 100%;
...
<body>
        ...
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                @if (!empty($data->profile_image))
                    <img src="{{ 'https://clinic.umdaa.co/uploads/doctors/' . $data->profile_image }}"
                        alt="{{ __($data->first_name) }}" class="img-fluid rounded-circle" />
                @endif
                <h1 class="text-light"><a href="index.html">Dr. {{ $data->first_name }} {{ $data->last_name }}</a>
                </h1>
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="#work" class="nav-link scrollto"><i class='bx bx-current-location'></i></i>
                            <span>Practice Location</span></a></li>
                </ul>
            </nav><!-- .nav-menu -->
        </div>
    </header><!-- End Header -->
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            ...
            @if (!empty($Listdocsavedservicess))
                <p> Services Offered <span class="typed" data-typed-items="{{ $Listdocsavedservicess }}"></span></p>
            @else
                <p> Services Offered <span class="typed" data-typed-items="{{ $ListdocServices }}"></span></p>
            @endif
            @if (!empty($data->doctor_id))
                <a href="{{ '//citizen.umdaa.co/#/bookwebslot/' . $data->doctor_id }}" class="btn btn-primary">Book
                    Appointment</a>
            @endif
        </div>
    </section><!-- End Hero -->
    ...
    <main id="main">
                    ...
                    @if (!empty($docsavedservicess))
                        @foreach ($docsavedservicess as $data)
                            @if ($data->service_status == 1)
                                <div class="col-lg-4 col-md-6 card1 aos-init aos-animate" data-aos="fade-up"
        ...
        <section id="work" class="background-alt">
            <div class="container">
                <div class="section-title">
