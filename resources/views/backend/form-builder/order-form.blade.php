    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'Order Form Builder' }}</h4>
                    ...
                    <div class="card-body">
                        ...
                        <ul id="sortable_02" class="available-form-field">
                            <li class="ui-state-default" type="text">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Text' }}
                            </li>
                            <li class="ui-state-default" type="email">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Email' }}
                            </li>
                            <li class="ui-state-default" type="tel">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Tel' }}
                            </li>
                            <li class="ui-state-default" type="url">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'URL' }}
                            </li>
                            <li class="ui-state-default" type="select">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Select' }}
                            </li>
                            <li class="ui-state-default" type="checkbox">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Check Box' }}
                            </li>
                            <li class="ui-state-default" type="file">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'File' }}
                            </li>
                            <li class="ui-state-default" type="textarea">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Textarea' }}
                            </li>
                            <li class="ui-state-default" type="password">
                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ 'Password' }}
                            </li>
                        </ul>
                    </div>
                </div>
