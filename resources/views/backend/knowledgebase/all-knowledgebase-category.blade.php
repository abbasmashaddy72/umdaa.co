    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'All Knowledgebase Topics' }}</h4>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-lg btn-danger btn-sm mb-3 mr-1"
                                                            ...
                                                            data-html="true" title="" data-content="
                                                                <h6>Are you sure to delete this topic?</h6>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'Add New Topics' }}</h4>
                        <form action="{{ route('admin.knowledge.category.new') }}" method="post"
