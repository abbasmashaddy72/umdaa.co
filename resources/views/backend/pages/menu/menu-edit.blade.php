                                                    ...
                                                    <ul class="page-list-ul">
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="1">
                                                                {{__('Home')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Home')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="2">{{__('About Us')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('About Us')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/about-us'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="3">{{__('Doc Services')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Doc Services')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/doc-services'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="4">{{__('A-Z')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('A-Z')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/a-z'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="5">{{__('Doctors')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Doctors')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/doctors'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="6">{{__('FAQ')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('FAQ')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/faq'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="6">{{__('Pricing')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Pricing')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/pricing'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="8">{{__('Blogs')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Blogs')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/blogs'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Contact Us')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Contact Us')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/contact-us'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Career With Us')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Career With Us')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/career-with-us'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Events')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Events')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/events'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Knowledge Base')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Knowledge Base')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/knowledgebase'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Login')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Login')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/login'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__('Form')}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{__('Form')}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/forms'}}">
                                                            <input type="hidden" class="menu-item-db-id" value="">
                                                        </li>
                                                        @foreach($all_page as $data)
                                                        <li>
                                                            <label class="menu-item-title">
                                                                <input type="checkbox" class="menu-item-checkbox" value="9">{{__($data->title)}}
                                                            </label>
                                                            <input type="hidden" class="menu-item-title" value="{{$data->title}}">
                                                            <input type="hidden" class="menu-item-url" value="{{'[url]/p/'.$data->id.'/'.Str::slug($data->title)}}">
                                                            <input type="hidden" class="menu-item-db-id" value="{{$data->id}}">
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                                    <div class="form-group">
                                                        <button type="button" id="add_page_to_menu" class="btn btn-primary btn-xs mt-4 pr-4 pl-4">{{__('Add To Menu')}}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <section id="drop_down_menu_builder_wrapper">
                                                ...
                                                print '<ol>';
                                                    ...
                                                    @endphp
                                                    <li style="display: list-item;" class="mjs-nestedSortable-branch mjs-nestedSortable-expanded" id="menuItem_{{$data->id}}" data-title="{{$data->menuTitle}}" data-url="{{$data->menuUrl}}">
                                                        <div class="menuDiv">
                                                            <span title="Click to show/hide children" class="disclose ui-icon ui-icon-minusthick"><span></span></span>
                                                            <span>
                                                                <span data-id="1" class="itemTitle">{{ str_replace(' ','_',$data->menuTitle) }}</span>
                                                        ...
                                                        @endforeach
                                                        @else
                                                    <li style="display: list-item;" class="mjs-nestedSortable-branch mjs-nestedSortable-expanded" id="menuItem_1" data-title="{{__('Home')}}" data-url="{{'[url]'}}">
                                                        <div class="menuDiv">
                                                            <span title="Click to show/hide children" class="disclose ui-icon ui-icon-minusthick"><span></span></span>
                                                            <span>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#add_custom_links', function(e) {
            ...
            if (labelText == '') {
                $('#custom_label_text').addClass('error');
            }
        ...
        $(document).on('click', '#menu_structure_submit_btn', function(e) {
            e.preventDefault();
            var arrr = $('ol.sortable').nestedSortable('toArray', {
                startDepthCount: 0
            });
            arrr.shift();
