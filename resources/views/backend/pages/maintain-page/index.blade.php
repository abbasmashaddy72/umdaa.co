    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'Maintain Page Settings' }}</h4>
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                <div class="tab-pane fade show active" role="tabpanel">
                                    <div class="form-group">
                                        <label for="maintain_page_title">{{ 'Title' }}</label>
                                        <input type="text" class="form-control" id="maintain_page_title"
                                            value="{{ get_static_option('maintain_page_title') }}"
                                            name="maintain_page_title" placeholder="{{ 'Title' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="maintain_page_description">{{ 'Description' }}</label>
                                ...
                                <div class="form-group">
                                    <label for="maintain_page_logo"><strong>{{ 'Logo' }}</strong></label>
                                    ...
                                    <small
                                        class="form-text text-muted">{{ 'allowed image format: jpg,jpeg,png. Recommended image size 300x100' }}</small>
                                </div>
                                <div class="form-group">
                                    <label
                                        for="maintain_page_background_image"><strong>{{ 'Background Image' }}</strong></label>
                                    <div class="media-upload-btn-wrapper">
                                        <div class="img-wrap">
                                            @php
                                            ...
                                            @if (!empty($maintain_page_background_image))
                                                ...
                                                @php  $maintain_page_background_image_btn_label = 'Change Image'; @endphp
                                            @endif
                                        </div>
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn"
                                            ...
                                            data-modaltitle="Upload Background Image" data-toggle="modal"
                                            data-target="#media_upload_modal">
                                            {{ $maintain_page_background_image_btn_label }}
                                        </button>
                                    </div>
                                    <small
                                        class="form-text text-muted">{{ 'allowed image format: jpg,jpeg,png. Recommended image size 1920x1000' }}</small>
                                </div>
                            </div>
