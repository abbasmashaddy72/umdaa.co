    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'Order Cancel Page Settings' }}</h4>
                        <form action="{{ route('admin.order.cancel.page') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <div class="form-group">
                                        <label for="site_order_cancel_page_title">{{ 'Main Title' }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="site_order_cancel_page_subtitle">{{ 'Subtitle' }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="site_order_cancel_page_description">{{ 'Description' }}</label>
                                        <textarea name="site_order_cancel_page_description" class="form-control"
                                            id="site_order_cancel_page_description" cols="30"
                                            rows="10">{{ get_static_option('site_order_cancel_page_description') }}</textarea>
                                    </div>
                                </div>
                            </div>
