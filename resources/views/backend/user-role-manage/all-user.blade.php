                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <h4 class="header-title">{{ 'All Admin Created By Super Admin' }}</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" data-id="{{ $data->id }}"
                                                                ...
                                                                data-image="{{ $img_url }}" data-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ 'User Details Edit' }}</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
                </div>
                <form action="{{ route('admin.user.update') }}" id="user_edit_modal_form" method="post"
                            ...
                            <div class="image-wrap">
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn"
                                        data-btntitle="Select Team Image" data-modaltitle="Upload Team Image"
