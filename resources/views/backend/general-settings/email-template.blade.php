    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'Email Template' }}</h4>
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.general.email.template') }}" method="POST"
                            ...
                            <div class="form-group">
                                <label for="site_global_email">{{ 'Global Email' }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">@username Will replace by username of user and @company
                                    will be replaced by site title also @message will be replced by dynamically with
                                    message.</small>
                            </div>
