    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ 'All Events Categories' }}</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-lg btn-danger btn-sm mb-3 mr-1"
                                                            ...
                                                            data-content="<h6>Are you sure to delete this category?</h6><form method='post' action='{{ route('admin.events.category.delete', $data->id) }}'><input type='hidden' name='_token' value='{{ csrf_token() }}'><br><input type='submit' class='btn btn-danger btn-sm' value='Yes,Delete'></form>">
                                                            <i class="ti-trash"></i>
                                                        </a>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.events.category.new') }}" method="post"
